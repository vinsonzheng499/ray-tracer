...
public:
  ...
  Fl_Check_Button *m_bvhCheckButton;
...
private:
  ...
  static void cb_bvhTreeDepthSlides(Fl_Widget *o, void *v);
  static void cb_bvhLeafSizeSlides(Fl_Widget *o, void *v);
  ...
  static void cb_bvhCheckButton(Fl_Widget *o, void *v);
